  ...
  return (
    <nav className='space-y-1'>
      <div className='flex flex-col items-center mb-5 pb-5 border-b border-zinc-100 dark:border-zinc-800'>
        <div 
          className='w-20 h-20 rounded-2xl overflow-hidden bg-zinc-100 dark:bg-zinc-800 flex-shrink-0 mb-3 shadow-sm cursor-pointer hover:shadow-md transition-shadow'
          onClick={() => router.push('/')}>
          {siteInfo?.icon ? (
