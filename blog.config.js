...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '90d171cd8e52833c964f817d08b594b0,en:7c1d570661754c8fbc568e00a01fd70e',
  THEME: process.env.NEXT_PUBLIC_THEME || 'NexLite', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '在光影交错的瞬间 我的镜头捕捉到了你', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.macro.wang', // 网站地址
